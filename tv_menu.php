...
<body>
    ...
    <header class="tv-top-header">
        ...
        <div id="happyHourBanner" class="happy-hour-pill idle">
            <i class="bi bi-clock-history" style="color:#facc15;"></i> Online Happy Hour: <strong>1:00 PM – 4:00 PM</strong> • Upto 10% off
        </div>
        ...
        <div class="header-right-deck">
            ...
            <div class="qr-header-card">
                ...
                <div class="qr-text">
                    ...
                    <span class="qr-sub">Scan to Order • Upto 10% off (1–4 PM)</span>
                </div>
            </div>
